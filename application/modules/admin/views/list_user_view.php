        ...
        <section class="content">
          ...
          <div class="row">            
            ...
            <section class="col-lg-12 connectedSortable">
                <button class="btn btn-danger"><a href="<?php echo base_url(); ?>admin/add" style="color:white">Add New User</a></button>&nbsp;
               <div class="box">
                    ...
                    <tbody>
                          <?php if(isset($results)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>admin/edit/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
