                                                       ...
                                                       <div class="panel-heading" role="tab" id="headingOne">
                                                           <h4 class="panel-title">
                                                               <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                  ...
                                                                  STEP 1: <strong><?=$loan->amount?></strong> xvg
                                                       ...
                                                       <div class="panel-heading" role="tab" id="headingTwo">
                                                           <h4 class="panel-title">
                                                               <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                   <i class="more-less glyphicon glyphicon-plus"></i>
                                                                 STEP 2: <strong><?=$loan->amount?></strong> xvg
                                                               </a>
                                                           </h4>
                                                       </div>
                                                       <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                           <div class="panel-body">
                                                               ...
                                                               <div class="col-md-12 formContainer">
                                                                   <div class="fs18 underline">DONATION AMOUNT (xvg) = <?=$loan->amount?> xvg </div>
                                                       
                                                                   <form name="proofForm" action="<?php echo base_url().'loan/send_money/'.$loan_id; ?>" method="post" class="frm_ajax">
