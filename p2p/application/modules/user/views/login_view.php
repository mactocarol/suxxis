    ...
    <body>
        ...
        <div class="overlay_panel">
        	<div class="login_panel">
                    ...
                    ?>
            		<div class="logo-login text-center"><a href="<?php echo site_url('Home');?>"><img src="<?php echo base_url('theme');?>/images/footer-logo.jpg"><span>P2P</span></a></div>
            		<form method="post" action="<?php echo site_url('user/login_check'); ?>">
                    	<div class="form-group"><input type="text" placeholder="Email / Username" name="email" class="input-text-login"> <i class="fa fa-user"></i></div>
                        <div class="form-group"><input type="password" placeholder="Password" name="password" class="input-text-login"> <i class="fa fa-key"></i></div>
                        <input type="submit" value="Login">
                    </form>
                    <div class="col-md-12 text-center"><a href="<?php echo site_url('forgot');?>" class="txt1">Forgot Username / Password?	</a> </div>
